...
import { LucideProps } from 'lucide-react-natRive';
...
export const Input = forwardRef<TextInput, InputProps>(
  (
    ...
    const cardColor = mode === 'dark' ? colors.BLACK : colors.WHITE;
    const textColor = mode === 'dark' ? colors.WHITE : colors.BLACK;
    const muted = colors.SHADOW;
    const borderColor = '#E5E7EB';
    const primary = colors.TAXIPRIMARY;
      ...
      switch (variant) {
        case 'outline':
          return {
            ...
            backgroundColor: mode === 'dark' ? colors.BLACK : 'transparent',
          };
        case 'filled':
        default:
          return {
              ...
              {(icon || label || rightComponent) && (
                ...
                >
                  ...
                  <View
                    ...
                    pointerEvents='none'
                  >
                    {icon && iconName && React.createElement(icon, {
                      name: iconName,
                      size: 16,
