      ...
      <Grid container spacing={3} className={classes.gridContainer}>
        ...
        <Grid item xs={12} md={6}>
          ...
          {settings && settings.AppleStoreLink?
            <a href={settings.AppleStoreLink}><img src={require("../assets/img/appstore.png")} alt="Apple Store Link" className="h-14 w-auto object-contain"/></a>
            :null}
            <span style={{marginRight: '5px'}}></span>
            {settings && settings.PlayStoreLink?
            <a href={settings.PlayStoreLink}><img src={require("../assets/img/playstore.png")} alt="Playstore Link" className="h-16 w-auto object-contain"/></a>
            :null}
        </Grid>
      </Grid>
    </Box>
