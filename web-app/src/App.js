...
import EditDynamicHour from "views/EditDynamicHour.js";
        ...
        <ThemeProvider theme={theme}>
          ...
          <BrowserRouter future={{ v7_relativeSplatPath: true, v7_startTransition: true }}>
              <Routes>
                ...
                <Route path="/dynamic-hours/edit" element={<ProtectedRoute permit={"admin"}><EditDynamicHour/></ProtectedRoute>}/>
                <Route path="/dynamic-hours/edit/:id" element={<ProtectedRoute permit={"admin"}><EditDynamicHour/></ProtectedRoute>}/>
                <Route path="/contact-us" element={<ContactUs />} />
